...
insert into memurlar values(1,'Gülay',20000,'Lisans');        --Primary key sebebiyle error verir.
insert into memurlar values(5,'Altug',25000,'Yüksek Lisans'); --Unique sebebiyle error verir.
